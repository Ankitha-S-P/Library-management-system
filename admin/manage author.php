    ...
    <?php
       ...
       while($row=mysqli_fetch_assoc($query_run)){
        ...
        <tr>
           ...
           <td> $name</td>
           <td>
             <button  class='btn' name='edit' ><a class='nav-link' href='editauthor.php?ano=$ID'> Edit </a></button>
             <button  class='btn' name='delete' ><a class='nav-link' href='deleteauthor.php?ano=$ID'> delete </a></button>
