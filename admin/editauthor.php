...
$connection=mysqli_connect("localhost","root","");
    ...
    $ID= "";
    $name="";
    $query="select * from authors where id=$_GET[ano]";
...
if(isset($_POST['edit'])){
    ...
    $query = "update authors set  name= '$_POST[name]' where id=$_GET[ano]";
    $query_run = mysqli_query($connection, $query);
        
        
if ($query_run) {
    echo "<script>alert('Author details updated successfully!'); window.location.href = 'manage author.php';</script>";
   
} else {
    echo "<script>alert('Update failed due to some error.... '); window.location.href = 'manage author.php';</script>";
