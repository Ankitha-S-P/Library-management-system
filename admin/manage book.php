...
$connection=mysqli_connect("localhost","root","");
    ...
    $category="";
    $price="";
    $query="select b.id as book_no,b.name as book_name,a.name as author_name,
            b.`purchase date` as purchase_date,c.name as category_name,b.price as price from books b,authors a,category c 
            where b.`author id`=a.id and b.category_id=c.id";
?>
<!doctype html>
<html>
    <head>
    ...
    <?php
       ...
       while($row=mysqli_fetch_assoc($query_run)){
        ...
        <tr>
           ...
           <td>
             <button  class='btn' name='edit' ><a class='nav-link' href='editbook.php?bno=$ID'> Edit </a></button>
             <button  class='btn' name='delete' ><a class='nav-link' href='deletebook.php?bno=$ID'> delete </a></button>
