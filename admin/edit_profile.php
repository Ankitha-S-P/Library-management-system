...
<html>
    ...
    </nav> <nav class="navbar navbar-expand-lg navbar-light" style="background-color: yellow">
    <div class="container-fluid">
   ...
   <div class="row">
    ...
    <div class="col-md-4">
        <form action="update.php" method="post">
            ...
            <input type="text" class="form-control" value="<?php echo $_SESSION['empno'] ?>" disabled >
